...
from tester_new import twoSampleContiTester, twoSampleDiscTester, two_sample_generator_uniform_perturb
import pandas as pd
import numpy as np
import torch
...
start = 1000
ntry = 50
values_param = np.array([start + i* 500 for i in range(ntry)])
...
for i in range(n_params):
    ...
    generator = two_sample_generator_uniform_perturb(
        cuda_device = device,
        n1 = param_now,
        n2 = param_now,
        d = 2)
