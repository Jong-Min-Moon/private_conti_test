...
n_n=20
values_n = np.linspace(500, 10000, n_n)
...
d_trend.to_csv("/mnt/nas/users/mjm/GitHub/private_conti_test/Python_implm/simulation_runs/two_sample/contiVsDisc/contiVsDisc.csv")
