...
from tester_new import twoSampleDiscTester, two_sample_generator_var_departure
import pandas as pd
import numpy as np
import torch
...
#n trend
n_n=20
values_n = np.linspace(5000, 50000, n_n)
...
n_trend.to_csv("/mnt/nas/users/mjm/GitHub/private_conti_test/Python_implm/simulation_runs/two_sample/disc/var/n/var_departure_n_trend.csv")
