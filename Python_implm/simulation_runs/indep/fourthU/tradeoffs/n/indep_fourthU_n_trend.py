...
n_n = 4
values_n = np.array([2,4,6,8])* 100000
...
n_trend.to_csv(
    "/mnt/nas/users/mjm/GitHub/private_conti_test/Python_implm/simulation_runs/indep/fourthU/tradeoffs/n/indep_fourthU_n_trend.csv"
    )
