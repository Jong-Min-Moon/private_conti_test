...
trend.to_csv(
    "/mnt/nas/users/mjm/GitHub/private_conti_test/Python_implm/simulation_runs/indep/tradeoffs/fourthU/tradeoffs/d/conti/indep_tradeoffs_fourthU_d_trend_conti.csv"
    )
